...
describe('Shipping utils tests', () => {
  ...
  describe('Check if selectCheapestSlaForAllItems works', () => {
    ...
    it('For Business Days case', () => {
      expect(
        selectCheapestSlaForAllItems(BUSINESS_DAYS_LOGISTICS_INFO)
      ).toEqual(EXPECTED_BUSINESS_DAYS_CHEAPEST_LOGISTICS_INFO)
    })
    it('For Days case', () => {
